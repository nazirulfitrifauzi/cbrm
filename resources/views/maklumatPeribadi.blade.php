<div x-show="tab === 'tab1'">
    <form method="post" action="{{ route('home.storePeribadi') }}">
        @csrf
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <div class="grid grid-cols-6 gap-6 mt-6">
                                ...
                                <div class="col-span-6 sm:col-span-2">
                                    ...
                                    <input id="age" name="age" type="number" value="{{ isset(auth()->user()->peribadi->age) ? auth()->user()->peribadi->age : old('age') }}"
                                        class="mt-1 form-input block w-full py-2 px-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
                                </div>
                                ...
                                <div class="col-span-6 sm:col-span-2">
                                    ...
                                    <select id="marital" name="marital"
                                        ...
                                        <option value="Ibu Tunggal"
                                            @if(isset(auth()->user()->peribadi->marital))
                                            @if(auth()->user()->peribadi->marital == 'Ibu Tunggal') selected @endif @else
                                            @endif>
                                            Ibu Tunggal</option>
                                    </select>
                                </div>
                                ...
                                <div class="col-span-6 sm:col-span-2">
                                    <label for="dependent"
                                        ...
                                        Tanggungan</label>
                                    <input id="dependent" name="dependent" type="number" value="{{ isset(auth()->user()->peribadi->dependent) ? auth()->user()->peribadi->dependent : old('dependent') }}"
                                        class="mt-1 form-input block w-full py-2 px-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
                                </div>
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="mt-3">
                                            <div class="flex items-center">
                                                ...
                                                <input id="oku_no" name="oku" value="Tidak" type="radio" @if(isset(auth()->user()->peribadi->oku))
                                ...
                                <div class="col-span-6">
                                    ...
                                    <input id="address1" name="address1" value="{{ isset(auth()->user()->peribadi->address1) ? auth()->user()->peribadi->address1 : old('address1') }}"
                                        class="mt-1 form-input block w-full py-2 px-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5" />

                                    <input id="address2" name="address2" value="{{ isset(auth()->user()->peribadi->address2) ? auth()->user()->peribadi->address1 : old('address2') }}"
                                        class="mt-1 form-input block w-full py-2 px-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
                                </div>
                                ...
                                <div class="col-span-6 sm:col-span-3 lg:col-span-2">
                                    ...
                                    <input id="postcode" name="postcode" value="{{ isset(auth()->user()->peribadi->postcode) ? auth()->user()->peribadi->postcode : old('postcode') }}"
                                        class="mt-1 form-input block w-full py-2 px-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
                                </div>
                                ...
                                <div class="col-span-6 sm:col-span-6 lg:col-span-2">
                                    ...
                                    <input id="city" name="city" value="{{ isset(auth()->user()->peribadi->city) ? auth()->user()->peribadi->city : old('city') }}"
                                        class="mt-1 form-input block w-full py-2 px-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
                                </div>
                                ...
                                <div class="col-span-6 sm:col-span-3">
                                    <label for="phone_home" class="block text-sm font-medium leading-5 text-gray-700">No
                                        Telefon
                                        (Rumah)</label>
                                    <input id="phone_home" name="phone_home" value="{{ isset(auth()->user()->peribadi->phone_home) ? auth()->user()->peribadi->phone_home : old('phone_home') }}"
                                        class="mt-1 form-input block w-full py-2 px-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
                                </div>
                                ...
                                <div class="col-span-6 sm:col-span-3">
                                    <label for="phone_hp" class="block text-sm font-medium leading-5 text-gray-700">No
                                        Telefon
                                        (HP)</label>
                                    <input id="phone_hp" name="phone_hp" value="{{ isset(auth()->user()->peribadi->phone_hp) ? auth()->user()->peribadi->phone_hp : old('phone_hp') }}"
                                        class="mt-1 form-input block w-full py-2 px-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
                                </div>
                                ...
                                <div class="col-span-6 sm:col-span-2">
                                    ...
                                    <input id="facebook" name="facebook" value="{{ isset(auth()->user()->peribadi->facebook) ? auth()->user()->peribadi->facebook : old('facebook') }}"
                                        class="mt-1 form-input block w-full py-2 px-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
                                </div>
                                ...
                                <div class="col-span-6 sm:col-span-2">
                                    ...
                                    <input id="instagram" name="instagram" value="{{ isset(auth()->user()->peribadi->instagram) ? auth()->user()->peribadi->instagram : old('instagram') }}"
                                        class="mt-1 form-input block w-full py-2 px-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
                                </div>
                                ...
                                <div class="col-span-6 sm:col-span-2">
                                    <label for="profession"
                                        ...
                                        Sekarang</label>
                                    <input id="profession" name="profession" value="{{ isset(auth()->user()->peribadi->profession) ? auth()->user()->peribadi->profession : old('profession') }}"
                                        class="mt-1 form-input block w-full py-2 px-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
                                </div>
                                ...
                                <div class="col-span-6 sm:col-span-2">
                                    ...
                                    <input id="employer_phone" name="employer_phone" value="{{ isset(auth()->user()->peribadi->employer_phone) ? auth()->user()->peribadi->employer_phone : old('employer_phone') }}"
                                        class="mt-1 form-input block w-full py-2 px-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
                                </div>
                                ...
                                <div class="col-span-6 sm:col-span-6 lg:col-span-2">
                                    <label for="employer_city"
                                        class="block text-sm font-medium leading-5 text-gray-700">Bandar</label>
                                    <input id="employer_city" name="employer_city" value="{{ isset(auth()->user()->peribadi->employer_city) ? auth()->user()->peribadi->employer_city : old('employer_city') }}"
                                        class="mt-1 form-input block w-full py-2 px-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
                                </div>
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            <div class="grid grid-cols-6 gap-6 mt-1">
                                ...
                                <div class="col-span-6 sm:col-span-6">
                                    ...
                                    <input id="spouse_name" name="spouse_name" value="{{ isset(auth()->user()->peribadi->spouse_name) ? auth()->user()->peribadi->spouse_name : old('spouse_name') }}"
                                        class="mt-1 form-input block w-full py-2 px-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
                                </div>
                                ...
                                <div class="col-span-6 sm:col-span-6">
                                    <label for="spouse_ic_no"
                                        class="block text-sm font-medium leading-5 text-gray-700">No.
                                        KP (Baru)</label>
                                    <input id="spouse_ic_no" name="spouse_ic_no" value="{{ isset(auth()->user()->peribadi->spouse_ic_no) ? auth()->user()->peribadi->spouse_ic_no : old('spouse_ic_no') }}"
                                        class="mt-1 form-input block w-full py-2 px-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
                                </div>
                                ...
                                <div class="col-span-6 sm:col-span-3 lg:col-span-2">
                                    ...
                                    <select id="spouse_employer_state" name="spouse_employer_state"
                                        ...
                                        <option value="1" @if(isset(auth()->user()->peribadi->spouse_employer_state))
                                            @if(auth()->user()->peribadi->spouse_employer_state == '1') selected @endif @else
                                            @endif>Johor</option>
                                        <option value="2" @if(isset(auth()->user()->peribadi->spouse_employer_state))
                                            @if(auth()->user()->peribadi->spouse_employer_state == '2') selected @endif @else
                                            @endif>Kedah</option>
                                    </select>
                                </div>
                            </div>

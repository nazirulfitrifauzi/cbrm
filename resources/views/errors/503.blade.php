...
<html lang="en">
    ...
    <body class="antialiased font-sans">
        ...
        <div class="w-full md:w-1/2 bg-white flex items-center justify-center ">
            <div class="max-w-sm m-8">
                <div class="flex-shrink-0">
                    <img src="{{ asset('img') }}/logo_tekun.png" />
                </div>
                <div class="text-black text-5xl md:text-10xl font-black">Sedang Diselenggara</div>
        ...
        <div class="relative pb-full md:flex md:pb-0 md:min-h-screen w-full md:w-1/2">
            <div style="background-image: url({{ asset('src/svg/503-illustration.svg') }});" class="absolute pin bg-cover bg-no-repeat md:bg-left lg:bg-center">
            </div>
        </div>
        </div>
    </body>

        ...
        <div class="max-w-7xl mx-auto pb-12 px-4 sm:px-6 lg:px-20">
            ...
            <div class="bg-gray-100 rounded-lg shadow px-5 py-6 sm:px-6">
                <div 
                                ...
                                <div class="bg-white rounded-lg px-4 pt-5 pb-4 overflow-hidden shadow-xl transform transition-all sm:max-w-xl sm:w-full sm:p-6"
                                    ...
                                    <div class="mt-5 sm:mt-6 sm:grid sm:grid-cols-2 sm:gap-3 sm:grid-flow-row-dense">
                                        <span class="flex w-full rounded-md shadow-sm sm:col-start-2">
                                            <a href="{{ route('cbrm.status') }}" type="button"
                                                ...
                                                <div class="text-center">
                                                    ...
                                                    <div class="mt-2 overflow-auto h-64">
                                                        ...
                                                        <table width="100%" class="table-auto">
                                                            ...
                                                            <tr class="text-sm text-gray-600">
                                                                <td class="align-top px-2 py-1">8.</td>
                                                                <td class="text-left px-2 py-1">Pemohon dengan ini
                                                                    membenarkan <b>TEKUN Nasional</b> / atau pegawainya
                                                                    untuk menggunakan, mendedahkan, memberitahu apa-apa
                                                                    maklumat berhubung dengan akaun pembiayaan TEKUN /
                                                                    untuk tujuan atau berhubung dengan apa-apa tindakan
                                                                    atau prosiding diambil bagi tujuan penilaian kredit
                                                                    atau bayaran balik di bawah Terma dan Syarat ini
                                                                </td>
                                                            </tr>
                                                            <tr class="text-sm text-gray-600">
                                                                <td class="align-top px-2 py-1">9.</td>
                                                                <td class="text-left px-2 py-1">Pemohon dengan ini
                                                                    membenarkan <b>TEKUN Nasional</b> / atau pegawainya
                                                                    untuk penzahiran apa-apa maklumat kredit individu
                                                                    yang berkaitan dengan kedudukan kredit, kemudahan
                                                                    atau butiran akaun pemohon kepada Experian
                                                                    Information Services (Malaysia) Sdn Bhd (dahulu
                                                                    dikenali sebagai RAMCI) ("Experian") dan / atau
                                                                    Credit Tip Off Service Sdn Bhd ("CTOS") serta
                                                                    pelanggan Experian / CTOS termasuk Bank, Institusi
                                                                    kewangan atau mana-mana agensi pelaporan kredit yang
                                                                    berkuat kuasa di Malaysia.</td>
                                                            </tr>
                                                            <tr class="text-sm text-gray-600">
                                                                <td class="align-top px-2 py-1">10.</td>
                                                                <td class="text-left px-2 py-1">Pemohon dengan ini
                                                                    memberi kebenaran kepada Experian dan / atau CTOS
                                                                    bagi pendedahan maklumat kredit, termasuk maklumat
                                                                    kredit perbankan kepada <b>TEKUN Nasional</b> / atau
                                                                    pegawainya bagi maksud yang berikut seperti yang
                                                                    dinyatakan di bawah seksyen 24, menurut Akta
                                                                    Pelaporan Kredit 2010. Persetujuan hendaklah kekal
                                                                    terpakai selagi pemohon mengekalkan akaun /
                    ...
                    {{-- card content --}}
                    @include('cbrm_maklumatPeribadi')
                    @include('cbrm_maklumatPerniagaan')
                    @include('cbrm_maklumatPinjaman')
                    {{-- end content --}}

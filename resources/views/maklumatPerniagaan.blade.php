                        ...
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <div class="col-span-6 sm:col-span-6">
                                ...
                                <select id="business_activity" name="business_activity"
                                    ...
                                    <option value="1" {{ old('business_activity') == 1 ? 'selected' : '' }}>Pendawaian elektrik
                                    </option>
                                    <option value="2" {{ old('business_activity') == 2 ? 'selected' : '' }}>Kedai pajak gadai
                                    </option>
                                </select>
                            </div>
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                <label for="business_phone_hp"
                                    class="block text-sm font-medium leading-5 text-gray-700">No
                                    Telefon (HP)</label>
                                <input id="business_phone_hp" name="business_phone_hp" value="{{old('business_phone_hp')}}"
                                    class="mt-1 form-input block w-full py-2 px-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
                            </div>
                            ...
                            <div class="col-span-6 sm:col-span-3 lg:col-span-2">
                                ...
                                <select id="business_premise" name="business_premise"
                                    class="mt-1 block form-select w-full py-2 px-3 py-0 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5">
                                    <option value="Sendiri" {{ old('business_premise') == "Sendiri" ? 'selected' : '' }}>Sendiri</option>
                                    <option value="Sewa" {{ old('business_premise') == "Sewa" ? 'selected' : '' }}>Sewa</option>
                                    <option value="Keluarga" {{ old('business_premise') == "Keluarga" ? 'selected' : '' }}>Keluarga</option>
                                    <option value="Persatuan" {{ old('business_premise') == "Persatuan" ? 'selected' : '' }}>Persatuan</option>
                                </select>
                            </div>
                            ...
                            <div class="col-span-6 sm:col-span-3 lg:col-span-2">
                                ...
                                <select id="business_ownership" name="business_ownership"
                                    class="mt-1 block form-select w-full py-2 px-3 py-0 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5">
                                    <option value="Individu" {{ old('business_ownership') == "Individu" ? 'selected' : '' }}>Individu</option>
                                    <option value="Pemilikan Tunggal" {{ old('business_ownership') == "Pemilikan Tunggal" ? 'selected' : '' }}>Pemilikan Tunggal
                                    </option>
                                    <option value="Perkongsian" {{ old('business_ownership') == "Perkongsian" ? 'selected' : '' }}>Perkongsian</option>
                                    <option value="Sendirian Berhad" {{ old('business_ownership') == "Sendirian Berhad" ? 'selected' : '' }}>Sendirian Berhad
                                    </option>
                                </select>
                            </div>
                            ...
                            <div class="col-span-6 sm:col-span-2">
                                <fieldset>
                                    <legend class="block text-sm font-medium leading-5 text-gray-700">Modal Berbayar</legend>
